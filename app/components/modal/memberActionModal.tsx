import type { IMember } from '~/interfaces/authTypes';
import React, {
  useEffect,
  useState,
  type ChangeEvent,
...
import { deleteAMember } from '~/services/api/membersApi';
...
const title = {
  EDIT: 'EDIT IMember DATA',
  VIEW: 'IMember DATA',
  DELETE: 'DELETE IMember',
};

const ViewData = ({ formData }: { formData?: IMember }) => (
  <form className='mb-4 space-y-4'>
    ...
    <div className='flex flex-row items-center space-x-4'>
      <div className='flex-1'>
        <Label htmlFor='ministry_primary' className='mb-3'>
          Ministry Primary
        </Label>

        <Select name='ministry_primary' value={formData?.ministry_primary ?? ''}>
          <SelectTrigger className='w-full'>
            <SelectValue placeholder='Ministry Primary' />
          </SelectTrigger>
          <SelectContent>
            <SelectGroup className='opacity-100 bg-white w-[180px]'>
              <SelectLabel>Ministry Primary</SelectLabel>
              ...
              <SelectItem value='believers class'>Believers class</SelectItem>
              <SelectItem value='sunday_school'>Sunday School</SelectItem>
              <SelectItem value='reception'>Reception</SelectItem>
              <SelectItem value='counselling'>Counselling</SelectItem>
              <SelectItem value='evangelism_Follow_up'>Evangelism & Follow up</SelectItem>
      ...
      <div className='flex-1'>
        ...
        <Select name='ministry_secondary' value={formData?.ministry_secondary ?? ''}>
          <SelectTrigger className='w-full'>
            <SelectValue placeholder='Ministry Secondary' />
          </SelectTrigger>
          <SelectContent>
            <SelectGroup className='opacity-100 bg-white w-[180px]'>
              <SelectLabel>Ministry Primary</SelectLabel>
    ...
    <div className='flex flex-row items-center space-x-4'>
      <div className='flex-1'>
        ...
        <Select name='ordination_category' value={formData?.ordination_category ?? ''}>
          <SelectTrigger className='w-full'>
      ...
      <div className='flex-1'>
        ...
        <div className='flex space-x-4'>
          <div className='flex items-center'>
            <Checkbox
              id='believers_class'
              name='believers_class'
              checked={formData?.believers_class}
            />
        ...
        <div className='flex space-x-4'>
          <div className='flex items-center'>
            <Checkbox
              id='water_baptism'
              name='water_baptism'
              checked={formData?.water_baptism}
            />
        ...
        <div className='flex space-x-4'>
          <div className='flex items-center'>
            <Checkbox
              ...
              name='wants_baptism_program'
              checked={formData?.wants_baptism_program}
            />
    ...
    <div className='flex flex-row items-center space-x-4 mt-4'>
      <div className='flex-1'>
        <Label htmlFor='holy_spirit_baptism' className='mb-3'>
          Holy Spirit Baptism
        </Label>
        <div className='flex space-x-4'>
          <div className='flex items-center'>
            <Checkbox
              ...
              checked={formData?.holy_spirit_baptism}
            />
            <Label htmlFor='holy_spirit_baptism' className='ml-2'>
              True
            </Label>
          </div>
        </div>
...
const EditData = ({ IMember }: { IMember?: IMember }) => {
  const [formData, setFormData] = useState<IMember | undefined>(IMember);
    ...
    <form className='mb-4 space-y-4'>
        ...
        <div className='flex-1'>
          ...
          <Select
            ...
            onValueChange={(e) => {
              setFormData({
                ...formData,
                marital_status: e as IMember['marital_status'],
              });
            }}>
            <SelectTrigger className='w-full'>
              <SelectValue placeholder='Marital status' />
        ...
        <div className='flex-1'>
          ...
          <Select
            ...
            onValueChange={(e) => {
              setFormData({
                ...formData,
                natural_group: e as IMember['natural_group'],
              });
            }}>
            <SelectTrigger className='w-full'>
              <SelectValue placeholder='Natural Group' />
        ...
        <div className='flex-1'>
          ...
          <Select
            ...
            onValueChange={(e) => {
              setFormData({
                ...formData,
                highest_Qualification: e as IMember['highest_Qualification'],
              });
            }}>
            <SelectTrigger className='w-full'>
              <SelectValue placeholder='Highest Qualification' />
        ...
        <div className='flex-1'>
          ...
          <Select
            ...
            onValueChange={(e) => {
              setFormData({
                ...formData,
                volunteer_service_area: e as IMember['volunteer_service_area'],
              });
            }}>
            <SelectTrigger className='w-full'>
              <SelectValue placeholder='Volunteer Service Area' />
      ...
      <div className='flex flex-row items-center space-x-4'>
        <div className='flex-1'>
          ...
          <Select
            name='ministry_primary'
            value={formData?.ministry_primary}
            onValueChange={(e) => {
              setFormData({
                ...formData,
                ministry_primary: e as IMember['ministry_primary'],
              });
            }}>
            <SelectTrigger className='w-full'>
              <SelectValue placeholder='Ministry Primary' />
        ...
        <div className='flex-1'>
          ...
          <Select
            name='ministry_secondary'
            value={formData?.ministry_secondary}
            onValueChange={(e) => {
              setFormData({
                ...formData,
                ministry_secondary: e as IMember['ministry_secondary'],
              });
            }}>
            <SelectTrigger className='w-full'>
              <SelectValue placeholder='Ministry Secondary' />
        ...
        <div className='flex-1'>
          ...
          <Select
            ...
            onValueChange={(e) => {
              setFormData({
                ...formData,
                ordination_category: e as IMember['ordination_category'],
              });
            }}>
            <SelectTrigger className='w-full'>
              <SelectValue placeholder='Ordination Category' />
          ...
          <div className='flex space-x-4'>
            <div className='flex items-center'>
              <Checkbox
                ...
                checked={formData?.believers_class}
                onCheckedChange={(e) => {
                  setFormData({ ...formData, believers_class: !formData?.believers_class });
                }}
              />
              <Label htmlFor='believers_class' className='ml-2'>
                True
          ...
          <div className='flex space-x-4'>
            <div className='flex items-center'>
              <Checkbox
                ...
                checked={formData?.water_baptism}
                onCheckedChange={(e) => {
                  setFormData({ ...formData, water_baptism: !formData?.water_baptism });
                }}
              />
              <Label htmlFor='water_baptism' className='ml-2'>
                True
            ...
            <div className='flex items-center'>
              <Checkbox
                ...
                onCheckedChange={(e) => {
                  setFormData({
                    ...formData,
                    wants_baptism_program: !formData?.wants_baptism_program,
                  });
                }}
              />
              <Label htmlFor='wants_baptism_program' className='ml-2'>
          ...
          <div className='flex space-x-4'>
            <div className='flex items-center'>
              <Checkbox
                ...
                checked={formData?.workers_training}
                onCheckedChange={(e) => {
                  setFormData({ ...formData, workers_training: !formData?.workers_training });
                }}
              />
              <Label htmlFor='workers_training' className='ml-2'>
                True
...
const DeleteData = ({ IMember }: { IMember?: IMember }) => {
  const [formData, setFormData] = useState<IMember | undefined>(IMember);
  const [isSubmitting, setIsSubmitting] = useState(false);
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    const { name, value, type, checked } = e.target;
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await deleteAMember({ id: IMember?.id ?? 0 });
      setIsSubmitting(false);
...
const DisplayView = ({
  ...
  else if (type == 'EDIT') return EditData({ IMember: memberData });
  else return DeleteData({ IMember: memberData });
};
