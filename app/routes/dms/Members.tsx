...
import { fetchAllMembers, registerAMember } from '~/services/api/membersApi';
import type { IMember } from '~/interfaces/authTypes';
import { toast } from 'sonner';
import ActionModal from '~/components/modal/memberActionModal';
...
export default function Members() {
  ...
  const [formData, setFormData] = useState<IMember>({
    ...
    water_baptism: true,
    wants_baptism_program: true,
    believers_class: true,
    ...
    province: '',
    region: '',
    ordination_certificate: 'cert123.jpg',
  });
    ...
    <div>
      ...
      <div className='my-10 flex flex-row items-center justify-center mx-auto px-10'>
        <div className='flex flex-row items-center space-x-4 overflow-x-scroll'>
          ...
          <div className='sm:w-full sm:space-x-3 md:w-[320px] sm:h-[83px] md:h-[93px] rounded-md bg-white shadow-md flex flex-row items-center justify-between p-4'>
            <div className='font-bold text-[50px] text-[#A49B9B]'>20</div>
            <div className='sm:w-[150px] flex flex-col items-start justify-center'>
              <div className='text-black'>MINISTERS</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog} modal>
        <DialogContent className='rounded-md shadow-lg max-h-[80vh] flex flex-col p-6 bg-white overflow-y-scroll'>
          ...
          <form className='mb-4 space-y-4' onSubmit={handleSubmit}>
            ...
            {/* <div className='font-bold text-xl text-left'>NEXT OF KIN</div>
            <div className='flex flex-row items-center space-x-4'>
              <div className='flex-1'>
                <Label htmlFor='next_of_kin_name' className='mb-3'>
                  Next of kin name
                </Label>
                <Input
                  id='next_of_kin_name'
              ...
              <div className='flex-1'>
                <Label htmlFor='next_of_kin_phone' className='mb-3'>
                  Next of kin phone
                </Label>
                <Input
            ...
            <div className='flex flex-row items-center space-x-4'>
              <div className='flex-1'>
                <Label htmlFor='next_of_kin_address' className='mb-3'>
                  next of kin address
                </Label>
                <Input
              ...
              <div className='flex-1'>
                <Label htmlFor='next_of_kin_relationship' className='mb-3'>
                  Next of kin relationship
                </Label>

                <Select>
                  <SelectTrigger className='w-full'>
                    <SelectValue placeholder='Next of Kin Relationship' />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectGroup className='opacity-100 bg-white w-[180px]'>
                      <SelectLabel>Next of Kin Relationship</SelectLabel>
            ...
            <div className='flex flex-row items-center space-x-4'>
              <div className='flex-1'>
                ...
                <Select
                  ...
                  onValueChange={(e) => {
                    setFormData({ ...formData, ministry_primary: e });
                  }}>
                  <SelectTrigger className='w-full'>
              ...
              <div className='flex-1'>
                ...
                <Select
                  ...
                  onValueChange={(e) => {
                    setFormData({ ...formData, ministry_secondary: e });
                  }}>
                  <SelectTrigger className='w-full'>
            ...
            <div className='flex flex-row items-center space-x-4'>
              <div className='flex-1'>
                ...
                <Select
                  ...
                  onValueChange={(e) => {
                    setFormData({ ...formData, ordination_category: e });
                  }}>
                  <SelectTrigger className='w-full'>
                  ...
                  <div className='flex items-center'>
                    <Checkbox
                      ...
                      onCheckedChange={(e) => {
                        setFormData({
                          ...formData,
                          believers_class: !formData.believers_class,
                        });
                      }}
                    />
